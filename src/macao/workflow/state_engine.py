...
class StateRecognitionEngine:
    ...
    def recognize_state(
        ...
        # Layer 1b: WAITING_REVIEW -> CONSENSUS_CHECK (When valid reviews >= minimum quorum)
            ...
            if reviews_dir.exists():
                ...
                if valid_count >= quorum:
                    return (
                        ...
                        "QUORUM_REACHED",
                        {"valid_reviews_count": valid_count, "minimum_quorum": quorum}
                    )

        # Layer 1c: CONSENSUS_CHECK -> MERGING or REWORK (Only from vote_result.json)
                ...
                try:
                    ...
                    if (is_valid and 
                        ...
                        if decision == "APPROVED":
                            return AgentState.MERGING, "VOTE_RESULT_APPROVED", vdata
                        elif decision == "REWORK_REQUIRED":
                            return AgentState.REWORK, "VOTE_RESULT_REWORK", vdata
                except Exception:
                    pass
