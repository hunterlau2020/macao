"""SQLite State Store Connection and Schema Initialization (PRD §11.4 / §11.6)."""
...
-- Message Deliveries Table for Fan-out / multi-recipient independent ACK (PRD §11.6)
CREATE TABLE IF NOT EXISTS message_deliveries (
    delivery_id     INTEGER PRIMARY KEY AUTOINCREMENT,
    message_id      TEXT NOT NULL REFERENCES message_queue(message_id),
